...
<script>
  ...
  // Installation docs
  const installDocs = `$ yarn add https://github.com/reuters-graphics/chart-module-vaccine-pace-chart.git`;

  // JavaScript docs
  $: jsDocs = `import Chart from '@reuters-graphics/chart-module-vaccine-pace-chart';
...
`;
  ...
  // SCSS docs
  const styleDocs = `$VaccinePaceChart-container: '.vaccine-pace-chart-container';
...
<div class='repo-link'>
  <a href="https://github.com/reuters-graphics/chart-module-vaccine-pace-chart" target="_blank">
    <Icon icon={faGithub} />
  </a>
</div>
